var DEOAUTHID = 'ELOS-KPC-DEO';
var L10AUTHID = 'ELOS-KPC-L10';
var L20AUTHID = 'ELOS-KPC-L20';
var PWRAUTHID = 'ELOS-KPC-PWR';
...
/*function createblankentry(datetime) {
        return { RdgDateTimeStr: datetime, SiteId: 'KPC123', UnitId: '', ReferenceCapacity: '', GDC: '', ActualDispatchMW: '', AmbTemp: '', SeaWaterTemp: '', AmbPressure: '', IsOutageDeration: 'N', IsForced: 'N', IsPlanned: 'N', IsLDC: 'N', IsGas: 'N', StartupRampId: 'N', Reason: '', AmbDeration: 0, ForcedDeration: 0, PlannedDeration: 0, L1Approvalbool: false, L1ApprovalCopy: false, L2Approvalbool: false, L2ApprovalCopy: false, CreateDateStr: '' };
}*/
...
function pastevaluestorow(refrecord, rowidx) {
   ...
   ////// //$('#divgrid').jqxGrid('ensurerowvisible', rowidx);
   ////// //$('#divgrid').jqxGrid('getrowdata', rowidx);
   ////// //var data = $('#divgrid').jqxGrid('getrowdata', rowidx);
   //////// console.log(data.visibleindex);
   ////// // $('#divgrid').jqxGrid('ensurerowvisible', data.visibleindex);
   ////// $('#divgrid').jqxGrid('sortby', 'RdgDateTimeStr', 'asc');
...
function InitializeForm() {
    urlFetchLedger = '/KPC/FetchLossLedger';
    urlPostLedger = '/KPC/PostChanges';
    ...
    gridColumns =
        [
            ...
            },
            {
                ...
                //datafield: LOVAdaptors.OutageDeration.records,
                displayfield: 'TXTOutageDeration',
                columntype: 'dropdownlist',
                width: 60,
                createeditor: function (row, value, editor) {
                    editor.jqxDropDownList({
                        autoDropDownHeight: true, source: LOVAdaptors.OutageDeration, displayMember: "Value", valueMember: "Key"
                    });
                ...
                cellclassname: fncellclass,
                cellbeginedit: fncellbeginedit,
                initeditor: fniniteditor,
                cellvaluechanging: fncellvaluechanging
            },
            {
...
var fncellvaluechanging = function (row, datafield, columntype, oldvalue, newvalue) {
    //var breaki=0;
}

var fniniteditor = function (row, cellvalue, editor, celltext, cellwidth, cellheight) {
